...
This project aims to help the user get familiar with Object Relational Mappers and its use in database scripting.
I got familiar with using MySQLdb and SQLAlchemy to create, edit, query and delete tables in MySQL.
